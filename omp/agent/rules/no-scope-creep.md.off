---
name: no-scope-creep
description: "ADVISORY ONLY (not a security control): scope-creep trip-wire when a fleet lane signals unrequested extra work mid-stream."
condition:
...
Re-read the assignment's acceptance criteria and continue only on what it named. This reminder
is ADVISORY ONLY — a model-context nudge, NOT an enforced control (P2-08).
